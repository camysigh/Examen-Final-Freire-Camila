...
#Esta funcion ayuda a irmprimir el directorio getwd()
#Si se le añade a setwd() ayuda a definir el directorio
def_dir <- setwd(getwd())
...
#tab_df(df_descriptive, alternate.rows = TRUE, title = "Table 1. RNA Summary", show.footnote = TRUE, footnote = "Expression of mRNA", file = "mRNA_expr_summary.doc")

tab_df(
  df_descriptive,
  title = "Table 1. RNA Summary",
  footnote = "Expression of mRNA",
  show.type = FALSE,
  show.rownames = FALSE,
  show.footnote = TRUE,
  digits = 2,
...
reg_gen_expression <- function(genes_cancer){
  ...
  filtro_comparacion_gen_Total <- cbind(filtro_comparacion_gen_1,filtro_comparacion_gen_2)
  filtro_comparacion_gen_Total_tibble <- tibble("dataset" = filtro_comparacion_gen_Total[,1], "gen1" = filtro_comparacion_gen_Total[,3], "gen2" = filtro_comparacion_gen_Total[,6])
