...
Como se puede observar el la **Tabla 1**, para todos los 7 genes dados, (es decir: *GATA3, PTEN, XBP1, ESR1, MUC1, FN1, y GAPDH*),  poseen una cantidad asignada de un nivel de expresión, para todo los tipos de Cancer presentes: *BRCA, OV, LUSC, KIPAN, KIRP, UCEC*. <br>

En cuanto al carcinoma ivasivo de mama (BRCA, por sus siglas en inglés), como se puede  observar en las tablas
